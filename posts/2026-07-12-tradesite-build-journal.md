...
*Reconstructed 2026-07-12 from `git log` across four repos. An adversarial review agent then attacked every dated claim against the history before publication; it found ten errors, and its own biggest finding — "the June 29 rewrite never happened" — fell to a backup bundle proving the old main tip is no ancestor of the new one. John Ward is a mechanical design engineer who fell into software in December 2025. Feedback welcome — file an issue on this repo.*
