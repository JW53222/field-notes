...
And I'm not the first to serve tools to visiting agents — I sent a research agent to check the day this published, and here's the lineage it confirmed: MCP-B (the project whose library I build on) began in January 2025 and shipped its public artifacts through mid-2025, its extension serving as an unofficial consumer long before Chrome's; [jasonjmcghee's WebMCP widget](https://github.com/jasonjmcghee/WebMCP) let sites expose tools to client-side agents from March 2025; and the agency [StudioMeyer](https://studiomeyer.io/en/blog/webmcp-reality-check-may-2026) says — by their own account, uncorroborated but plausible — they'd been shipping agent-callable surfaces on client sites in a custom pre-spec shape since roughly May 2025. The pattern predates me. I was an early *adopter* in production, not the inventor of the idea.
