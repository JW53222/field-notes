...
3. **Attribution is role-level.** Personal origin requires text I *typed*, timestamped, in the session logs. My recall doesn't count — the audit caught my memory contradicting the git record more than once.
